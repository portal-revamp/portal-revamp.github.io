                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="https://vsmthane.org" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="assets/images/vsmlogo.png" alt="" height="30">
                                </span>
                                <span class="logo-lg">
                                    <img src="assets/images/vsmlogo.png" alt="" height="30">
                                </span>
...
<li>
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <!-- <div class="row align-items-center"> -->
                            ...
                            <form id="donor" data-parsley-validate="" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                            <div class="row">
                                <div class="card">
                                    <div class="card-body">
  ...
  <div class="row">
    <div class="col-sm-2">
                                                ...
                                                <div>
                                                    <input type="text" class="form-control"  id='fname'
                                                            parsley-type="text" placeholder="Enter first name" maxlength=20 required=""/>
                                                </div>
    </div>
    <div class="col-sm-2">
    <label class="h6">Middle Name</label>
                                                <div>
    ...
    <div class="col-sm-2">
    <label class="h6">Occupation</label>
    ...
    <label class="h6">PAN Card *</label>
                                                ...
                                                <div class="col-sm-2">
                                                <label class="h6">Donor Type *</label>
                                                <div>
  ...
  <div class="col-sm-2">
  <label class="h6">Donor Importance *</label>
  <div>
                                                <select class="form-control " id="donorimportance" required="">
                                                    <option value="">Select</option>
  ...
  <div class="col-sm-2">
    <div>
    <label class="h6">Government Servant *</label>
                                                <select class="form-control " id="govtservant" required="">
                                                    <option value="">Select</option>
  ...
  <div class="col-sm-2">
      <div>
  <label class="h6">VSM Connection *</label>
                                                <select class="form-control " id="vsmconnection" required="">
                                                    <option value="">Select</option>
    ...
    <label class="h6">Email</label>
                                                <div>
                                                   <input type="email" id="email" class="form-control" parsley-type="email" parsley-trigger="change" placeholder="Enter a valid e-mail" autocomplete="off">
                                                </div>
</div>
<div class="col-sm-2">
<label class="h6">Alt Email </label>
                                                <div>
                                                   <input type="email" id="altemail" class="form-control" parsley-type="email" parsley-trigger="change" placeholder="Enter a valid e-mail" autocomplete="off">
                                                </div>
</div>
<div class="col-sm-2">
<label class="h6">Mobile Number </label>
                                        ...
                                        <div class="col-sm-2">
     <label class="h6">Alt Mobile </label>
                                                <div>
...
<h6>Other Details</h6>
    ...
    <div class="col-sm-2">
    <label class="h6">Referral *</label>
                                                <select class="form-control " class="referral" required="">
                                                    <option value="">Select</option>
...
<label class="h6">Referral Details*</label>
                                                ...
                                                <div class="col-sm-2">
<label class="h6">Other Details</label>
...
$(function () {
  $('#donor').parsley().on('field:validated', function() {
